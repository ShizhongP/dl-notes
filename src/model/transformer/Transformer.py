...
class Transformer(nn.Module):
    def __init__(self, vocab_size, dim_embedding, num_layers, num_heads, dim_ff, dropout):
        ...
        self.encoder = Encoder(dim_embedding, num_layers,
                               num_heads, dim_ff, dropout)
        self.decoder = Decoder(dim_embedding, num_layers,
                               num_heads, dim_ff, dropout)
...
def test():
    ...
    transformer = Transformer(
        vocab_size, dim_embedding, num_layers, num_heads, dim_ff, dropout)
