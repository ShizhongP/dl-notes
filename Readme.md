...
最好给自己的电脑配一个linux的系统,Ubuntu,ArchLinux都行。学习基本的环境变量的配置，基本的指令操作，以及一些在服务器上能用到的工具啊之类的

## 杂谈

我觉得作为一名计算机类的学生(当然对其他专业的学生也是一样)，首先要具备自学的能力，而自学能力不仅是能深入理解知识，快速上手，能力迁移，也包括解决问题的能力。自己也还在探索的过程，我希望自己能真真切切做到以下几点

- 遇到问题，如何解决?

可以根据自己具备的基本知识，定位问题的关键，代码都是程序，都有运行逻辑，那一步错了，根据报错，思考下相关原理，尝试自己修改代码or相关配置。向 gpt 之类的提问，大部分时候他会给你一些灵感。上搜索引擎(google),或者看对应代码仓库,或者官方文档
...
工程更偏向于实践，我觉得一名好的科研人员，工程能力一定不能弱，不管代码能力多强，如果一个项目的组织结构很差，或者可读性很差，都不好。科研更偏向于发现现有研究方法存在的问题，或者说在某个方向上或某个实际场景中，缺少一个好的方法，你要试图去解决这些问题。当然，好的科研并不只是a+b的工作（我的意思是不希望只是为了发文章而发文章），有时候我们需要做一些开拓性的工作。也许这只是我现阶段的想法，正在努力往上走，也希望能看到更多的，更广阔的东西。个人拙见，勿喷:)
